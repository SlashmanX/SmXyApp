...
function onDeviceReady() {
    ...
    var url="http://slashmanx.com/admin/android/getPosts.php";
		...
		{	
			...
			{
				post = postsArray[i];
				var newList = "<li data-theme='c' class='ui-btn ui-btn-icon-right ui-li ui-btn-up-c' id='post-"+ post.id+"'>";
				...
				newList+="<h3 class='ui-li-heading'>"+ post.title +"</h3>";
				newList+="<p class='ui-li-desc'>"+ post.date_posted+"</p>";
				newList+="</a>";
				newList+="</div>";
